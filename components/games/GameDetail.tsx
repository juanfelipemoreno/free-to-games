  ...
  return (
    <div>
      <div className="relative h-105 overflow-hidden">
        ...
        {/* <div className="absolute inset-0 bg-[linear-gradient(to_top,var(--bg-void)_0%,rgba(2,4,8,0.3)_50%,transparent_100%),linear-gradient(to_right,var(--bg-void)_0%,transparent_40%)]" /> */}
        <div id='gradient-image'></div>
        <div className="absolute bottom-10 left-10 max-w-xl">
          <Link
            href="/"
            className="inline-flex items-center gap-2 font-['Share_Tech_Mono'] text-[11px] tracking-widest text-slate-500 hover:text-cyan-400 transition-colors mb-5"
          >
            ← VOLVER AL CATÁLOGO
          </Link>
